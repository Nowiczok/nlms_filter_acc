...
-- Date        : Mon May  8 19:55:47 2023
-- Host        : DESKTOP-P6SHRJL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top system_top_axi_smc_2 -prefix
--               system_top_axi_smc_2_ system_top_axi_smc_2_stub.vhdl
-- Design      : system_top_axi_smc_2
...
entity system_top_axi_smc_2 is
  Port ( 
    aclk : in STD_LOGIC;
...
end system_top_axi_smc_2;

architecture stub of system_top_axi_smc_2 is
...
attribute X_CORE_INFO of stub : architecture is "bd_a7a5,Vivado 2022.2";
begin
end;
