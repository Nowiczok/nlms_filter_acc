...
HD_PWD='D:/fpga_projects/SDUP/projekt/nlms_acc/nlms_acc.runs/system_top_lmb_bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_top_lmb_bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_top_lmb_bram_2.tcl
