...
//Date        : Sun Jun 18 14:20:14 2023
//Host        : DESKTOP-P6SHRJL running 64-bit major release  (build 9200)
//Command     : generate_target nlms_hw_system.bd
//Design      : nlms_hw_system
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "nlms_hw_system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=nlms_hw_system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "nlms_hw_system.hwdef" *) 
module nlms_hw_system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  nlms_hw_system_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  nlms_hw_system_axi_smc_0 axi_smc
  ...
  nlms_hw_system_nlms_top_0_0 nlms_top_0
       (.bram_addr_a(axi_bram_ctrl_0_BRAM_PORTA_ADDR[11:0]),
        ...
        .bram_wrdata_a(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .bram_wrdata_b(axi_bram_ctrl_0_BRAM_PORTB_DIN));
  nlms_hw_system_processing_system7_0_0 processing_system7_0
  ...
  nlms_hw_system_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
