...
HD_PWD='D:/fpga_projects/SDUP/projekt/nlms_acc_hw/nlms_acc_hw.runs/nlms_hw_system_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nlms_hw_system_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nlms_hw_system_axi_smc_0.tcl
