...
HD_PWD='D:/fpga_projects/SDUP/projekt/nlms_acc_hw/nlms_acc_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nlms_hw_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nlms_hw_system_wrapper.tcl -notrace
